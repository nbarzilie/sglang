...
class TestNixlNodeFailure(CustomTestCase):
    def _make_manager(self):
        ...
        mgr.transfer_statuses = {
            3: TransferStatus(),
            4: TransferStatus(is_failure=True),
            5: TransferStatus(
                received_aux=True,
        ...
        mgr.request_status = {3: KVPoll.WaitingForInput, 4: KVPoll.Transferring}
        mgr.update_status = CommonKVManager.update_status.__get__(
            mgr, CommonKVManager
        )
        return mgr
